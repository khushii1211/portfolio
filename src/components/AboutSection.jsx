export default function AboutSection() {
  return <section className="about-editorial reveal" id="about">
    <div className="about-title" aria-hidden="true"><span>AB</span><span>OUT</span></div>
    <div className="about-visual">
      <div className="about-photo-main"><img src="western5.PNG" alt="Khushi Chauhan editorial portrait" /></div>
      <div className="about-photo-detail"><img src="jwellery2.jpeg" alt="Khushi Chauhan jewellery close-up" /></div>
      <p className="about-caption">Beauty in expression<br/>Strength in stillness</p>
    </div>
