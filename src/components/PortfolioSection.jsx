...
export default function PortfolioSection({ onSelect }) {
  ...
  return <section className="portfolio reveal" id="portfolio">
    <div className="portfolio-head"><div><p className="section-no">03 / Selected work</p><h2>Portfolio</h2></div><p>A curated selection of western, bridal and ethnic work.</p></div>
